...
// 事件的稳定配图 id：优先取 localEvent.art（与 summary 文案解耦，改名不丢图），缺省回退 djb2(summary)。
...
const THEME_KW: Array<[NodeTheme, RegExp]> = [
  ...
  ['conflict', /战|斗|杀|袭|搏|刺|决斗|厮|围攻|火并|对峙|交锋|血战|出招|拔刀|拔剑|炮|劫匪|强敌|大战|围杀|海战|斩|兵临|攻城/],
  ['betray', /叛|背|出卖|内鬼|反水|倒戈|构陷|诬|告密|反扑|哗变|众叛|内变|暗算/],
  ['crisis', /危|险|劫|陷|困|崩|塌|毒|瘟|疫|灾|风暴|围城|断粮|追杀|逃|追兵|心魔|天劫|瓶颈|质问|动荡|失控|围困|绝境|告急|症/],
  ['scheme', /谋|策|计|算|局|间谍|密|诈|奏|参|弹劾|账册|名册|名单|布防|献策|进言|对策|劝降|招安|权衡|筹谋|定计|盘查|周旋/],
  ...
  ['setback', /败|落魄|贬|黜|逐|流落|潦倒|蹉跎|黯然|冷落|被弃|散尽|羞辱|受辱|身败|名裂|碌碌|泯然|失意|重伤|缠身|苟延/],
